package io.hpp.noosphere.gw.security;
...
public final class SecurityUtils {
  ...
  public static Map<String, Object> extractDetailsFromTokenAttributes(Map<String, Object> attributes) {
    ...
    String walletAddress = (String) attributes.get(PROPERTY_NAME_WALLET_ADDRESS);
    if (walletAddress != null) {
      details.put(PROPERTY_NAME_WALLET_ADDRESS, walletAddress);
    }
